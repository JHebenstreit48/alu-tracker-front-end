...
const Carousel: ImageCarouselType[] = [
  ...
  { path: '/images/cars/F/Ferrari/fxxk.webp' },
  { path: '/images/cars/B/Bugatti/chironpursport.webp' },
  { path: '/images/cars/V/VandaElectrics/dendrobium.webp' },
  ...
  { path: '/images/cars/L/Lamborghini/centenario.webp' },
