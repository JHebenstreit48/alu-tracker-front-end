...
import { normalizeString } from "@/components/CarInformation/CarDetails/Miscellaneous/StorageUtils";
import type { CarsLocationState } from "@/components/CarInformation/CarDetails/types";
