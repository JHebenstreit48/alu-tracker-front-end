...
import ObtainableVia from '@/components/CarDataForm/Form/CarFields/ObtainableVia';
import type { OvEntryDraft } from '@/components/CarDataForm/Form/CarFields/ObtainableVia';
