import type { StatSnapshot } from "@/components/Cars/CarDetails/Tables/StarsStats/utils/format";
import { fmt } from "@/components/Cars/CarDetails/Tables/StarsStats/utils/format";
