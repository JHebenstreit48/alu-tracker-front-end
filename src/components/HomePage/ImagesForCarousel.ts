...
const Carousel: ImageCarouselType[] = [
  ...
  { path: '/images/cars/A/Apex/ap0.jpg' },
  ...
  { path: '/images/cars/M/McLaren/p1.jpg' },
  { path: '/images/cars/K/Koenigsegg/regera.jpg' },
  { path: '/images/cars/R/Rimac/conceptone.jpg' },
  { path: '/images/cars/F/Ferrari/laferrari.jpg' },
